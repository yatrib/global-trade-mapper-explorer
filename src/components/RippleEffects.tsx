...
const EffectCard: React.FC<EffectCardProps> = ({ icon, title, summary, fullContent }) => {
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-4 flex justify-center">
            <Button 
              variant="ghost" 
              size="sm" 
              className="text-infomineo-blue hover:text-infomineo-blue/80 p-0"
              ...
              {effects.map((effect, index) => (
                <CarouselItem key={index} className="md:basis-1/3 pl-4">
                  <EffectCard 
                    ...
                    fullContent={effect.fullContent}
                  />
                </CarouselItem>
              ))}
            </CarouselContent>
