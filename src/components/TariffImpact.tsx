      ...
      <div className="h-full flex">
        <div className="p-8 bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] w-full flex flex-col">
          ...
          <div className="mt-4 flex justify-center">
            <Button variant="ghost" size="sm" className="text-infomineo-red hover:text-infomineo-red/80 p-0" onClick={() => setIsDialogOpen(true)}>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {impacts.map((impact, index) => <ImpactCard key={index} icon={impact.icon} title={impact.title} summary={impact.summary} fullContent={impact.fullContent} />)}
          </div>
        </div>
      </div>
    </section>;
